...
export function HeaderCountrySelector({ defaultCountry, onCountryChange }: HeaderCountrySelectorProps) {
  return (
    <div className="flex items-center gap-2">
      <Globe className="h-4 w-4 text-muted-foreground" />
      <Select value={defaultCountry} onValueChange={onCountryChange}>
        <SelectTrigger 
          data-testid="select-default-country-mobile" 
        ...
        <SelectContent>
          {COUNTRIES.map((country) => (
            <SelectItem 
              key={country.code} 
              value={country.code}
              data-testid={`option-country-mobile-${country.code}`}
            >
              {country.name}
            </SelectItem>
          ))}
